module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    },
    {
      postDate: new Date(),
      taskId: '958529',
      taskRequestedBy: 'Little Red Riding Hood',
      userTaskPool: '',
      status: 'pending',
